    ...
    return (
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 text-center pt-32">
        <div className="max-w-md w-full animate-in fade-in zoom-in duration-700">
          ...
          <h2 className="font-futuristic text-4xl mb-4 tracking-widest">PEDIDO CONFIRMADO</h2>
          <p className="text-neutral-400 font-light tracking-wide mb-8">
            Gracias por tu compra. Hemos enviado los detalles de confirmación a <span className="text-white">{formData.email}</span>.
          </p>
          <button 
    ...
    <div className="min-h-screen bg-black text-white pt-32 pb-24 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-12">
          <div>
            <h2 className="font-futuristic text-3xl mb-2 tracking-widest">CHECKOUT</h2>
            <p className="text-neutral-500 font-light text-sm tracking-wider uppercase">INFORMACIÓN DE ENVÍO</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
             <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest text-neutral-500">Nombre</label>
                    <input
                        required
                        name="firstName"
                ...
                <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest text-neutral-500">Apellido</label>
                    <input
                        required
                        name="lastName"
             ...
             <div className="space-y-2">
                <label className="text-[10px] uppercase tracking-widest text-neutral-500">Dirección</label>
                <input
                    required
                    name="address"
             ...
             <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest text-neutral-500">Ciudad</label>
                    <input
                        required
                        name="city"
                        value={formData.city}
                ...
                <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest text-neutral-500">Código Postal</label>
                    <input
                        required
                        name="zipCode"
        ...
        <div className="lg:pl-12 lg:border-l border-white/10">
          <div className="sticky top-32">
            <h2 className="font-futuristic text-xl mb-8 tracking-widest text-right">RESUMEN</h2>
               ...
               {items.map(item => (
                   <div key={item.id} className="flex gap-4">
                       ...
                       <div className="flex-1">
                           <h3 className="font-futuristic text-sm tracking-wider uppercase mb-1">{item.name}</h3>
                           <p className="text-[10px] text-neutral-500 tracking-wider">CANT: {item.quantity}</p>
                       </div>
                       <div className="text-right">
                           <p className="font-light tracking-wide">${(item.price || (item.category === "tech" ? 999 : 399)) * item.quantity}</p>
                       </div>
                   </div>
               ))}
            </div>
