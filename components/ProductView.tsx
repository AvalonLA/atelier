              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-6">
                  <div className="text-3xl font-light">
                    ${product.price ? product.price.toLocaleString() : (product.category === "tech" ? "999" : "399")}
                  </div>
                  
                  <button
                    onClick={() => {
                      // Add price if missing in product object
                      const price = product.price || (product.category === "tech" ? 999 : 399);
                 ...
                 <div className="flex gap-4">
                    <button 
                      onClick={() => {
                          ...
                          const text = encodeURIComponent(`Hola, estoy interesado en ${product.name}.`);
