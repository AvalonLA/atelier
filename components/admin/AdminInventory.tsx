      ...
      <div className="bg-white dark:bg-[#111] w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-xl shadow-2xl flex flex-col md:flex-row overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8 bg-neutral-50 dark:bg-neutral-900 border-t md:border-t-0 md:border-l border-neutral-200 dark:border-white/10 flex flex-col gap-4 min-w-[250px]">
          ...
          <div className="flex gap-2 pt-4">
            <button
              onClick={onClose}
              className="flex-1 py-3 text-xs font-bold border border-neutral-300 dark:border-neutral-700 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:text-white transition-colors"
            >
              CANCELAR
            </button>
            <button
              onClick={() => onSave(formData)}
              className="flex-1 py-3 text-xs font-bold bg-black dark:bg-white text-white dark:text-black rounded hover:opacity-80 transition-opacity"
            >
              GUARDAR CAMBIOS
            </button>
          </div>
