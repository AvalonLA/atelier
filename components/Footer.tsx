    ...
    <footer id="contact" className="bg-[#050505] text-white py-24 px-6 border-t border-white/5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
        <div className="col-span-1 md:col-span-2">
          <h2 className="font-futuristic text-3xl tracking-[0.3em] font-extralight mb-8">ATELIER</h2>
          <p className="text-neutral-500 max-w-sm font-light text-sm leading-relaxed">
            El futuro de la modulación lumínica. Diseñado en la era digital, creado para la excelencia física.
          </p>
        </div>
        
        <div>
          <h4 className="font-futuristic text-[10px] tracking-widest mb-6 opacity-40">SOCIALES</h4>
          <ul className="space-y-4 font-light text-sm text-neutral-400">
            <li><a href="https://www.instagram.com/atelieriluminacion" target="_blank" className="hover:text-white transition-colors">INSTAGRAM</a></li>
        ...
        <div>
          <h4 className="font-futuristic text-[10px] tracking-widest mb-6 opacity-40">CONTACTO</h4>
          <ul className="space-y-4 font-light text-sm text-neutral-400">
