...
const VisionSection: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="h-[80vh] relative flex items-center justify-center bg-black overflow-hidden group"
    >
      <div
      ...
      <div className="relative z-10 text-center max-w-4xl px-6">
        <h2 className="text-3xl md:text-6xl font-extralight tracking-tight mb-16 italic opacity-60 uppercase leading-tight">
          Diseño que trasciende la función para convertirse en{" "}
          <span className="text-white opacity-100 not-italic">luz pura.</span>
        </h2>
